  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    ...
    /* ================= [P3 修复] 补充缺失的命名路由 ================= */
      ...
      case '/category': {
        ...
        final categoryId = args?['categoryId'] as String? ?? args?['category_id'] as String? ?? '';
        final categoryName = args?['categoryName'] as String? ?? args?['category_name'] as String? ?? '';
        return _fade(
      ...
      case '/search': {
        ...
        final keyword = args?['keyword'] as String? ?? args?['query'] as String? ?? '';
      ...
      case '/seller-profile': {
        final args = settings.arguments as Map<String, dynamic>?;
        final sellerId = args?['seller_id'] as String? ?? args?['sellerId'] as String? ?? '';
        // ✅ 实际类名是 SellerProfileViewPage
        return _fade(SellerProfileViewPage(sellerId: sellerId), '/seller-profile');
      }
