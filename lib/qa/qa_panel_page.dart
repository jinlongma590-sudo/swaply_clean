...
class QaPanelPage extends StatelessWidget {
  ...
  void _showMockRewardBottomSheet(BuildContext context) {
    final mockData = {
      ...
      'points': 100,
      'pool': [
        {'id': 'airtime_100', 'title': '\$1 Airtime (100 Pts)', 'weight': 2},
        {'id': 'airtime_5', 'title': '5 Points', 'weight': 20},
        {'id': 'airtime_10', 'title': '10 Points', 'weight': 10},
        {'id': 'boost_cat_3d', 'title': '3‑day Category Boost', 'weight': 28},
        {'id': 'boost_search_3d', 'title': '3‑day Search Boost', 'weight': 28},
        {'id': 'boost_trending_3d', 'title': '3‑day Trending Boost', 'weight': 12},
      ],
